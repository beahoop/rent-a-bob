    ...
    <div className="row  mx-0">
      ...
      <div className="row">
        ...
        <div className="col-10 col-md-6 col-lg-5 mx-auto about-text">
          <p>Rent-A-Bob computers was started in 2005 in response to a need on the Isle of Palms for direct computer help to residents and small businesses. We offer in person or remote help for your home or office.  We can assist with all computer, network, or printer issues as needed.
          </p>
